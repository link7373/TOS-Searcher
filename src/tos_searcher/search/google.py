...
class GoogleProvider:
    ...
    def search(self, query: str, max_results: int = 50) -> list[str]:
        try:
            from search_engines.google_search import (
                extract_search_results,
                get_search_url,
            )
        except ImportError:
            logger.warning("search-engines not installed, skipping Google")
            return []
        ...
        try:
            ...
            # Google is the most likely to block scraping — fail gracefully
